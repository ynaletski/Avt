...
#define Delta_max_out_err 30
#define Delta_max_inp_err 30
...
extern int Delta_SV_beg[]; // значение частоты вращения
...
extern int Delta_SA_beg[];
extern int Delta_SD_beg[];
