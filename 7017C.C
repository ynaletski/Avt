...
//        sscanf(cb_COM[ii],">%4x%4x%4x%4x%4x%4x%4x%4x",         // для  TT= 0d
          sscanf(cb_COM[ii],">%4lx%4lx%4lx%4lx%4lx%4lx%4lx%4lx%4lx%4lx", // для TT= 1A,07 7017Z
...
//              if(flag_O3) f_reg_P(); // регулятор давления
         ...
         //   ftmp=(dat_i[itmp]*4/5 + 13107); // configuration 4...20 , signal 0...20

              ftmp=dat_i[itmp];
              ADC[1]= ftmp;
              s_MVD[0].Volt_A= ftmp * analog_scale[1] + analog_offset[1];
           }

           // напряжение источника питания 24V
         ...
         //   ftmp=(dat_i[itmp]*4/5 + 13107); // configuration 4...20 , signal 0...20
              ...
              ADC[2]= ftmp;
              s_MVD[0].Volt_DC= ftmp * analog_scale[2] + analog_offset[2];
           }
       }
